...
import { Button, Col, Deletable, FormField, Heading, Input, Row, Section } from 'Components/common/ui';

function CrudAttack({ title, attacks, onChangeAttacks }) {
